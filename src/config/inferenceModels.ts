...
/** Common OpenAI-compatible models. Local/open-source first, then cloud (alphabetical within). */
export const INFERENCE_MODEL_OPTIONS: InferenceModelOption[] = [
    // --- Local / open-source (alphabetical by provider, then model) ---
    // llama.cpp
    { id: 'default', label: 'llama.cpp default', provider: 'llamacpp' },
    // LM Studio
    { id: 'default', label: 'LM Studio default', provider: 'lmstudio' },
    // Ollama
    ...
    // vLLM
    { id: 'default', label: 'vLLM default', provider: 'vllm' },
    // --- Cloud / subscription (alphabetical by provider, then model) ---
    // Cerebras
